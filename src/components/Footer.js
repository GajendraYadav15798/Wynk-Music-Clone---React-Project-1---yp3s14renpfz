...
function Footer() {
  return (
    <div className="footer">
      ...
      <div class="about">
        <span class="about-item">ABOUT US | </span>
        <span class="about-item">PRIVACY POLICY | </span>
        <span class="about-item">TERMS OF USE | </span>
        <span class="about-item">CONTACT US | </span>
